...
country = {
	...
	COLONIZATION_INTEREST_COST_INITIAL = 50, --was 100
...
diplomacy = {
	...
	GW_WARSCORE_COST_MOD_2 = 0.25, -- cost reduction factor on warscore needed to fulfill goal if late game great war
